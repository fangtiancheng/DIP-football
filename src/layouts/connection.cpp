...
//            [this](){
//        qDebug() << "connection closed, refreshed!\n";
//        this->greetingMessage = tr("undefined");
//        this->username = tr("unknown");
//        this->connState = WaitingForGreeting;
