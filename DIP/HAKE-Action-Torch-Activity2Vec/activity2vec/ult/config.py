...
# adjust the icon to select whether the part action is showed on the screen
__C.DEMO.SHOW_PASTA = False
# __C.DEMO.MAX_HUMAN_NUM = 5
# assume that a football match contains at most 2 * 11 + 3 = 25 people
__C.DEMO.MAX_HUMAN_NUM = 25
