...
# mode = 0
# debug_mode, True will return json
DEBUG = True
##########################################################################################
...
M = np.array([[-1.67478953e+00, -8.52848644e+00,  1.38238244e+03],
              [-7.97903359e-01, -1.50011865e+01,  2.36298475e+03],
              [-6.92616207e-04, -1.39889698e-02,  1.00000000e+00]]).astype(np.float32)
use_network_sportsfield = True
